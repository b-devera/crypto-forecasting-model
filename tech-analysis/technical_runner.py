...
# print("\n===================Data Visualization==================")
pd_dr = pd.date_range(date(2022, 10, 1), date(2022, 12, 31), freq='d')
date_list = []
for x in pd_dr:
    x = str(x)[0:10]
    date_list.append(x)
...
final_pred.extend(final_pred)
trail = final_pred[0:8]
final_pred.extend(trail)
print(final_pred)
